...
- [x] Add auth guard to AI explain endpoint
- [x] Add pronunciation, difficulty hint, and alternative meaning to AI response
...
- [x] Expand Vocabulary schema to persist all AI fields
...
- [x] Show instant translation in popover for single word selections
- [x] Bilingual example sentences with bold-highlighted target word
- [x] Show original reading context in sidebar with highlighted word
- [x] Add one-click save to vocabulary flow

### Vocabulary Frontend

- [x] Display full AI data on vocabulary list page
